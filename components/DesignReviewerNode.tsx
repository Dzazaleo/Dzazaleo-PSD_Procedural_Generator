...
export const DesignReviewerNode = memo(({ id, data }: NodeProps<PSDNodeData>) => {
    ...
    useEffect(() => { updateNodeInternals(id); }, [id, instanceCount, activeInstances, updateNodeInternals]);
...
5. DO NOT assume the current position is 0. Use the provided 'currentRelativeX/Y'.`;
    ...
    return (
        <div className={`w-[450px] bg-slate-800 rounded-lg shadow-2xl border border-slate-600 font-sans flex flex-col transition-all duration-300 ${!hasFunctionalInput ? 'opacity-50 grayscale' : ''}`}>
